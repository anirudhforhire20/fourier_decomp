...
class Wndw {
    ...
    constructor(icon)
    {
        ...
        if(homescreen.windows.length != 0)
        {
            ...
            window.style.left = (document.defaultView.getComputedStyle(i.icon.icon).left).toString();
            window.style.top = (document.defaultView.getComputedStyle(i.icon.icon).top).toString();
